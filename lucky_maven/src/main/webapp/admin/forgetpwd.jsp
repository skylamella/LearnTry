...
<body onload="getPassCode()">
	<div class="panel admin-panel">
		<div class="body-content">
			<form id="form" class="form-x" method="post" action="login.xhtml">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" id="passcode" name="passcode" size="50" placeholder="请输入验证码" data-validate="required:请输入验证码,length#==4:验证码为4位" /> <img id="passCodeImg"
							src="<%=request.getContextPath()%>/check/CreateCheckImage.xhtml" alt="" width="100" class="code" style="height: 43px; cursor: pointer;"
							onclick="this.src='<%=request.getContextPath()%>/check/CreateCheckImage.xhtml?'+ Math.random()">
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<button class="button bg-main icon-check-square-o" onclick="return submitCHK()">提交</button>
					</div>
				</div>
			</form>
		</div>
